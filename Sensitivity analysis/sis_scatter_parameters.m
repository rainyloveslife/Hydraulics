...
rootPath='/Users/zeyu/remote/BSI/scratch/zduanmu/quincy_exp/';
folderPath='exp_82_hydraulics_ET_g0_ParaSen_51d3421c/';%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% editable
discard=loadMatData(rootPath,folderPath,'parameter_list/fileTime.mat');
discard_mask=discard==122640;
parameter_sample=readtable(strcat(rootPath,folderPath,'parameter_list/parameter_table.txt'));
parameter_sample(1, :) = [];
...
g0_p4=0.01;
% g1_medlyn_p4=4.64;%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% editable
parameter_table=parameter_sample.*g0_p4;%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% editable
parameter_table(~discard_mask)=[];
...
g1_ET=loadMatData('/Users/zeyu/remote/home_drive/2025/Feb/sensitivity_analysis/g0_ET_sim.mat');%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% editable
g1_GPP=loadMatData('/Users/zeyu/remote/home_drive/2025/Feb/sensitivity_analysis/g0_GPP_sim.mat');%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% editable
g1_NPP=loadMatData('/Users/zeyu/remote/home_drive/2025/Feb/sensitivity_analysis/g0_NPP_sim.mat');%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% editable
...
for t=1:3
    ...
    for i=1:size(g1_GPP,3)
        ...
        sta_mat(i,:)=[std_o,std_sim,rmse,rho,p];

    end
    savepath='/Users/zeyu/Desktop/PhD work report/202502/Sensitivity analysis/';
    save(strcat(savepath,'g0_',y_name{1,t},'_sta.mat'),'sta_mat');%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% editable
...
%%
cd('/Users/zeyu/Desktop/PhD work report/202502/Sensitivity analysis/matrixplot/');
rootPath='/Users/zeyu/remote/BSI/scratch/zduanmu/quincy_exp/';
folderPath='exp_82_hydraulics_ET_g0_ParaSen_51d3421c/';%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% editable
discard=loadMatData(rootPath,folderPath,'parameter_list/fileTime.mat');
discard_mask=discard==122640;
...
ET_sta=loadMatData('/Users/zeyu/Desktop/PhD work report/202502/Sensitivity analysis/g0_ET_sta.mat');
GPP_sta=loadMatData('/Users/zeyu/Desktop/PhD work report/202502/Sensitivity analysis/g0_GPP_sta.mat');
NPP_sta=loadMatData('/Users/zeyu/Desktop/PhD work report/202502/Sensitivity analysis/g0_NPP_sta.mat');
...
for t=1:numel(typename)
    ...
    title(strcat('g_0',32,typename{1,t}));
    set(gca,'FontSize',ftsize);

    str= strcat('/Users/zeyu/Desktop/PhD work report/202502/Sensitivity analysis/g0_',typename{1,t},'.tiff');
