...
save_dir = "/Net/Groups/BSI/work_scratch/zduanmu/phd/ERA5_forcing/ERA5_raw/Hartheim"
...
for year in range(2000, 2025):  # 2000到2024年
    for variable in variables:
        for month in range(1, 13):
            ...
            target_file = os.path.join(save_dir, f"Hartheim_{variable}_{year}_{month_str}.nc")
